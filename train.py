...
if __name__ == "__main__":
    ...
    # logger
    trainer_kwargs["logger"] = instantiate_from_config(trainer_config.pop("logger"))
    ...
    # trainer_kwargs["strategy"] = "deepspeed_stage_1"
    ...
    if len(opt.test_sd) > 0:
        ...
        # model.load_state_dict(torch.load('ckpts/srl-olgt-50k.ckpt', map_location='cpu'), strict=False)
